...
type System struct {
	...
	UseLocalAssets       bool   `mapstructure:"use_local_assets"`
	LocalAssets          string `mapstructure:"local_assets"`
	IsReplaceDownloadUrl bool   `mapstructure:"is_replace_download_url"`
